...
<script>
    ...
    export default {
        ...
        methods: {
            getSelectedNodes () {
                const nodes = findComponentsDownward(this, 'TreeTableNode');
        ...
        mounted () {
            ...
            this.$on('on-selected', () => {
                debugger;
                this.$emit('changed', this.getSelectedNodes());
